...
int main(void)
{
    ...
    while(1)
    {
        ...
        else if(c==2)
        {
            ...
            sendto(sock_desc,server_msg,sizeof(server_msg),0,(struct sockaddr*)&server_addr,server_struct_size);
            close(sock_desc);
            return 0;
        }
        else
        {
            ...
            if(recvfrom(sock_desc,server_msg,sizeof(server_msg),0,(struct sockaddr*)&server_addr,&server_struct_size)<0)
            {
